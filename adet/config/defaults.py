...
# Instance hyper-parameters
_C.MODEL.POLO.INSTANCE_IN_FEATURES = ["p2", "p3", "p4", "p5", "p6"]
_C.MODEL.POLO.FPN_INSTANCE_STRIDES = [8, 8, 16, 32, 32]
_C.MODEL.POLO.FPN_SCALE_RANGES = ((1, 96), (48, 192), (96, 384), (192, 768), (384, 2048))
_C.MODEL.POLO.SIGMA = 0.2
# Channel size for the instance head.
...
# Number of foreground classes.
_C.MODEL.POLO.NUM_CLASSES = 80
_C.MODEL.POLO.NUM_KERNELS = 32
_C.MODEL.POLO.NORM = "GN"
_C.MODEL.POLO.USE_COORD_CONV = True
_C.MODEL.POLO.PRIOR_PROB = 0.01
...
# Test cfg.
_C.MODEL.POLO.NMS_PRE = 500
_C.MODEL.POLO.SCORE_THR = 0.0005
_C.MODEL.POLO.UPDATE_THR = 0.0005
_C.MODEL.POLO.MASK_THR = 0.5
_C.MODEL.POLO.MAX_PER_IMG = 100
# NMS type: matrix OR mask.
_C.MODEL.POLO.NMS_TYPE = "matrix"
# Matrix NMS kernel type: gaussian OR linear.
_C.MODEL.POLO.NMS_KERNEL = "gaussian"
_C.MODEL.POLO.NMS_SIGMA = 2

# Loss cfg.
_C.MODEL.POLO.LOSS = CN()
# _C.MODEL.POLO.LOSS.FOCAL_USE_SIGMOID = True
# _C.MODEL.POLO.LOSS.FOCAL_ALPHA = 0.25
# _C.MODEL.POLO.LOSS.FOCAL_GAMMA = 2.0
# _C.MODEL.POLO.LOSS.FOCAL_WEIGHT = 1.0
# _C.MODEL.POLO.LOSS.DICE_WEIGHT = 3.0
_C.MODEL.POLO.LOSS.OBJ_WEIGHT = 0.010
_C.MODEL.POLO.LOSS.SEGCROSS_WEIGHT = 1.0
_C.MODEL.POLO.LOSS.SEGCROSS_CLASSES_WEIGHT = None
_C.MODEL.POLO.LOSS.SEGLOVASZ_WEIGHT = 0.5
